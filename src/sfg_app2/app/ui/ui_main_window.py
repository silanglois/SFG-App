...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionIgnore_selected_files.setText(QCoreApplication.translate("MainWindow", u"Ignore files...", None))
        ...
        self.mainTabWidget.setTabText(self.mainTabWidget.indexOf(self.processingTab), QCoreApplication.translate("MainWindow", u"Process / Review", None))
        self.mainTabWidget.setTabText(self.mainTabWidget.indexOf(self.processedResultsTab), QCoreApplication.translate("MainWindow", u"Spectra Library", None))
        self.mainTabWidget.setTabText(self.mainTabWidget.indexOf(self.postProcessingTab), QCoreApplication.translate("MainWindow", u"Fitting", None))
